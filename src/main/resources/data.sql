...
VALUES (1, 'admin@example.com', 'Admin', 'Adminov', '$2a$10$rLls/wZcKmMPgjalrbU6O.pPiqNfJiF4fFg/YFZ9TKEtbOSGybE3G','admin'),
       (2, 'user@example.com', 'User', 'Userov', '$2a$10$vg28sup.GulV1T7UymjzS.Nzcue.yLXUFRPNP1hv1NNt1j24GWewO', 'user');
